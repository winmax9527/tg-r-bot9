...
async def startup_event():
    ...
    # 打印一个超大声的日志，证明新代码跑起来了
    print("🚀🚀🚀 RELOADING: NATIVE HTTP VERSION STARTED 🚀🚀🚀")
